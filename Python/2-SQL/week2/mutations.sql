...
FOREIGN KEY (category_id) REFERENCES categories(employee_id);
...
INSERT INTO employee_expertise (employee_id, category_id)
...
WHERE e.city = 'London' AND c.category_name = 'Dairy Products';
